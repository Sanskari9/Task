...
const Header = () => {
  return (
    <nav className=" w-full max-w-[95vw] flex items-center justify-between min-h-[96px] px-8 py-4 ml-6  bg-black text-white">
      ...
      <a href="/blog" className="text-xl px-6 mr-8">Blog</a>
    </nav>
  )
}
