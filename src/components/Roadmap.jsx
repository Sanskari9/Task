...
const Roadmap = () => {
  return (
    <div className='absolute top-[920px] w-[90vw] h-[700px] px-2 flex'>
        <div>
      <h1 className=" text-5xl  uppercase font-bold mx-4 px-4 mt-4 mb-8  text-white md:text-4xl">
        Roadmap
      </h1>
      ...
      <div className=" text-white w-full max-w-[700px] h-[480px] flex flex-col px-12 my-16 py-14 justify-between">
        <div >
          <h2 className="text-5xl font-bold md:text-4xl">Connect with Games</h2>
          <p className="text-3xl font-medium">Feb 2023</p>
        </div>
        <div className='mt-4' >
          <h2 className="text-5xl font-bold md:text-4xl">Launch 3Ming.List</h2>
      ...
      <div className=" text-white w-full max-w-[700px] h-[690px]  flex flex-col mt-6  justify-between ">
        <div className="pl-6 ml-6 mt-6 ">
          <h2 className="text-5xl font-bold md:text-4xl">Comming Soon page</h2>
          <p className="text-3xl font-medium">Jan 2023</p>
        </div>
        <div className="pl-6 ml-6 mt-4">
          <h2 className="text-5xl font-bold md:text-4xl">5 College Game Events</h2>
          <p className="text-3xl font-medium">March 2023</p>
        </div>
        <div className="pl-6 m-6">
          <h2 className="text-5xl font-bold md:text-4xl">Launch 3Ming.Stream</h2>
